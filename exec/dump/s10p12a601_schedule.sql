...
CREATE TABLE `schedule` (
  ...
  `day` enum('MON','TUE','WED','THU','FRI','SAT','SUN') COLLATE utf8mb4_bin NOT NULL,
  `end_time` time(6) NOT NULL,
  `start_time` time(6) NOT NULL,
  `unit` int(11) NOT NULL,
  `user_id` bigint(20) NOT NULL,
  `day_type` enum('MON','TUE','WED','THU','FRI','SAT','SUN') COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2024-02-15 12:40:08
